  ...
  return (
    <>
      <Container>
        <div>
          <p>
            Hello, Dear friends, Welcome to Auction also, we are happy you want
          ...
          <p>
            ...
            your problem. So, kindly if you don't get any solution then mention
            it in the comment section.
          </p>
          <p>
            Also, we are trying to provide fresh &amp; latest content that
            provides you ideas about all updated information that's happening in
            the world.
          </p>
          <p>
          ...
          <p>
            Basically, we focus on the Shopping niche so, our main priority is
            to search for new content and present it in front of you to learn
            something new.{" "}
          </p>
          <h3>
          ...
          <p>
            We are mainly focused on the Shopping category so, we provide
            Shopping related content if you are interested in the Shopping
            category then you can visit daily to get more latest information.
          </p>
          <p>Auction provides online shopping experience.</p>
          <p>
            On our website Auction you get can all Shopping related information
            also, we focus on many other categories and we hope you like also,
            the content of other categories that are maintained on our website.
            So, you can visit our website homepage to know all category details
            here you can visit our homepage Click here
            <a href="https: www.auction.ba">Auction</a>
          </p>
          <p>
            ...
            Homepage visit now. <a href="https: www.auction.ba">Auction</a>
          </p>
          <h3>About Auction</h3>
          <p>
            As you can see already we mention what is our goal and Service again
            we repeat that we mainly focus on Shopping Category to help people.
          </p>
          <p>
            This Website is Created By Auction to help people because many
            people are still spending hours of time to get exact information so,
            this is the only motive to create{" "}
            <a href="https: www.auction.ba">Auction</a> to help people and
          ...
          <h3>
            <b>Admin's Statement for Auction</b>
          </h3>
          <p>
            ...
            information so, the first priority of our website Auction is to
          ...
          <p>
            ...
            can contact me by using following contact details.
          </p>
